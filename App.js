  ...
  return (
    <View style={stylesInicio.container}>
      ...
      <View style={stylesInicio.footer}>
        <Image source={{ uri: 'https://github.com/GabrielBarbxsaaZx999/logoiamagens/blob/main/Logo3.png?raw=true' }} style={stylesInicio.footerLogo} />
        <Text style={stylesInicio.footerText}>
    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        <View style={stylesInicio.tudo}>
          ...
          <View style={stylesInicio.sections1}>
            <Image
              source={{ uri: 'https://t4.ftcdn.net/jpg/04/12/63/51/360_F_412635103_crZRbjCFpXACc8NBjZHWoFxvYmcLKpKm.jpg' }}
              style={{ flex: 1, width: '100%', height: '100%', }}
            />
          </View>
          <View style={stylesInicio.sections}>
            <Image
              source={{ uri: 'https://st3.depositphotos.com/1047356/12656/i/450/depositphotos_126567870-stock-photo-conceptual-soccer-ball.jpg' }}
              style={{ flex: 1, width: '100%', height: '100%', }}
              resizeMode="cover" // Isso garante que a imagem cubra toda a área do contêiner
            />
          </View>

          <View style={stylesInicio.sections}>
            <Image
              source={{ uri: 'https://i.pinimg.com/736x/c3/b5/7a/c3b57a92b3ac6cafac8f4dd92625a570.jpg' }}
              style={{ flex: 1, width: '100%', height: '100%', }}
              resizeMode="cover" // Isso garante que a imagem cubra toda a área do contêiner
            />
          </View>
